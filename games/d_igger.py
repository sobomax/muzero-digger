...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Self-Play
        self.num_workers = 13  # Number of simultaneous threads/workers self-playing to feed the replay buffer
        ...
        self.batch_size = 192  # Number of parts of games to train on at each training step
        self.checkpoint_interval = int(2e3)  # Number of training steps before using the model for self-playing
        ...
        ### Replay Buffer
        self.replay_buffer_size = 750  # Number of self-play games to keep in the replay buffer
...
class Game(AbstractGame):
    ...
    def step(self, action):
        ...
        return observation[:2], reward / 600, done
